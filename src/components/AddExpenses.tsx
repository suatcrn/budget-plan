  ...
  return (
    <>
      ...
      <div className={expenseList.length < 1 ? "col col-md-8 col-lg-12 d-flex flex-column  gap-3 rounded mx-auto  p-3" :
        ...
        <div className="w-100">
        {(expense?.expenseName && expense?.expenseAmount ) ? <button className="w-100 btn btn-primary p-1" onClick={handleAdd} >Add</button> : <button className="w-100 btn btn-primary p-1 disabled" onClick={handleAdd} >Add</button>} 
        </div>
      </div>
